...
function AppPreview() {
  return (
    <div className="relative bg-card/95 backdrop-blur-2xl rounded-2xl border border-border/50 shadow-2xl overflow-hidden origin-top-left scale-[0.75] xl:scale-[0.82] 2xl:scale-90 min-w-[680px]">
      {/* macOS Window Bar */}
