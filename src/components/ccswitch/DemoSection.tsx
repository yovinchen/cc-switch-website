...
function StatsContent() {
  ...
  // Different data sets for each time period - varied trends for each metric
  const chartDataSets = {
    '24小时': [
      { date: '00:00', requests: 45, cost: 2.8, inputToken: 2800, outputToken: 320, writeCache: 420, hitCache: 1580 },
      { date: '01:00', requests: 38, cost: 2.2, inputToken: 2200, outputToken: 280, writeCache: 480, hitCache: 1420 },
      { date: '02:00', requests: 22, cost: 1.5, inputToken: 1400, outputToken: 195, writeCache: 520, hitCache: 1180 },
      { date: '03:00', requests: 15, cost: 0.9, inputToken: 850, outputToken: 120, writeCache: 380, hitCache: 980 },
      { date: '04:00', requests: 12, cost: 0.6, inputToken: 620, outputToken: 85, writeCache: 290, hitCache: 850 },
      { date: '05:00', requests: 18, cost: 0.8, inputToken: 780, outputToken: 95, writeCache: 350, hitCache: 920 },
      { date: '06:00', requests: 35, cost: 1.4, inputToken: 1800, outputToken: 165, writeCache: 520, hitCache: 1250 },
      { date: '07:00', requests: 68, cost: 2.5, inputToken: 3800, outputToken: 285, writeCache: 680, hitCache: 1850 },
      { date: '08:00', requests: 112, cost: 3.8, inputToken: 6200, outputToken: 420, writeCache: 850, hitCache: 2400 },
      { date: '09:00', requests: 156, cost: 4.2, inputToken: 8500, outputToken: 520, writeCache: 720, hitCache: 3200 },
      { date: '10:00', requests: 189, cost: 5.1, inputToken: 9800, outputToken: 580, writeCache: 650, hitCache: 3850 },
      { date: '11:00', requests: 203, cost: 5.8, inputToken: 10500, outputToken: 620, writeCache: 580, hitCache: 4200 },
      { date: '12:00', requests: 198, cost: 6.2, inputToken: 9200, outputToken: 680, writeCache: 520, hitCache: 4580 },
      { date: '13:00', requests: 178, cost: 5.5, inputToken: 8800, outputToken: 720, writeCache: 480, hitCache: 4820 },
      { date: '14:00', requests: 165, cost: 4.8, inputToken: 8200, outputToken: 780, writeCache: 550, hitCache: 4650 },
      { date: '15:00', requests: 185, cost: 5.2, inputToken: 9500, outputToken: 850, writeCache: 620, hitCache: 4280 },
      { date: '16:00', requests: 210, cost: 6.5, inputToken: 11200, outputToken: 920, writeCache: 720, hitCache: 3950 },
      { date: '17:00', requests: 195, cost: 7.2, inputToken: 10800, outputToken: 980, writeCache: 850, hitCache: 3580 },
      { date: '18:00', requests: 168, cost: 6.8, inputToken: 9200, outputToken: 880, writeCache: 920, hitCache: 3120 },
      { date: '19:00', requests: 145, cost: 5.5, inputToken: 7800, outputToken: 750, writeCache: 980, hitCache: 2680 },
      { date: '20:00', requests: 125, cost: 4.2, inputToken: 6500, outputToken: 620, writeCache: 850, hitCache: 2250 },
      { date: '21:00', requests: 98, cost: 3.5, inputToken: 5200, outputToken: 480, writeCache: 720, hitCache: 1850 },
      { date: '22:00', requests: 72, cost: 2.8, inputToken: 3800, outputToken: 380, writeCache: 580, hitCache: 1520 },
      { date: '23:00', requests: 55, cost: 2.2, inputToken: 2900, outputToken: 295, writeCache: 480, hitCache: 1380 },
    ],
    '7天': [
      { date: '12/20 00', requests: 234, cost: 12.5, inputToken: 4200, outputToken: 380, writeCache: 850, hitCache: 2650 },
      { date: '12/20 06', requests: 312, cost: 14.2, inputToken: 5500, outputToken: 420, writeCache: 920, hitCache: 3100 },
      { date: '12/20 12', requests: 456, cost: 18.3, inputToken: 7800, outputToken: 520, writeCache: 780, hitCache: 3850 },
      { date: '12/20 18', requests: 389, cost: 22.5, inputToken: 8200, outputToken: 580, writeCache: 650, hitCache: 4200 },
      { date: '12/21 00', requests: 298, cost: 19.8, inputToken: 7200, outputToken: 650, writeCache: 580, hitCache: 4580 },
      { date: '12/21 06', requests: 345, cost: 16.5, inputToken: 6800, outputToken: 720, writeCache: 520, hitCache: 4950 },
      { date: '12/21 12', requests: 512, cost: 24.2, inputToken: 9500, outputToken: 680, writeCache: 620, hitCache: 5200 },
      { date: '12/21 18', requests: 478, cost: 28.5, inputToken: 10200, outputToken: 580, writeCache: 750, hitCache: 4850 },
      { date: '12/22 00', requests: 356, cost: 21.8, inputToken: 8800, outputToken: 520, writeCache: 880, hitCache: 4280 },
      { date: '12/22 06', requests: 289, cost: 15.2, inputToken: 6500, outputToken: 420, writeCache: 950, hitCache: 3680 },
      { date: '12/22 12', requests: 378, cost: 18.8, inputToken: 7200, outputToken: 380, writeCache: 1020, hitCache: 3250 },
      { date: '12/22 18', requests: 412, cost: 22.5, inputToken: 8500, outputToken: 450, writeCache: 1150, hitCache: 2980 },
      { date: '12/23 00', requests: 325, cost: 17.2, inputToken: 7800, outputToken: 520, writeCache: 1080, hitCache: 2650 },
      { date: '12/23 06', requests: 268, cost: 14.5, inputToken: 6200, outputToken: 580, writeCache: 920, hitCache: 2420 },
      { date: '12/23 12', requests: 356, cost: 19.8, inputToken: 7500, outputToken: 650, writeCache: 780, hitCache: 2850 },
      { date: '12/23 18', requests: 398, cost: 25.2, inputToken: 8800, outputToken: 720, writeCache: 680, hitCache: 3280 },
      { date: '12/24 00', requests: 312, cost: 22.8, inputToken: 8200, outputToken: 780, writeCache: 620, hitCache: 3650 },
      { date: '12/24 06', requests: 245, cost: 18.5, inputToken: 7200, outputToken: 850, writeCache: 580, hitCache: 3920 },
      { date: '12/24 12', requests: 289, cost: 15.2, inputToken: 6500, outputToken: 920, writeCache: 650, hitCache: 4150 },
      { date: '12/24 18', requests: 198, cost: 12.8, inputToken: 5200, outputToken: 880, writeCache: 720, hitCache: 3850 },
      { date: '12/25 00', requests: 145, cost: 9.5, inputToken: 4200, outputToken: 750, writeCache: 850, hitCache: 3280 },
      { date: '12/25 06', requests: 112, cost: 7.2, inputToken: 3500, outputToken: 620, writeCache: 920, hitCache: 2650 },
      { date: '12/25 12', requests: 98, cost: 5.8, inputToken: 2800, outputToken: 520, writeCache: 980, hitCache: 2120 },
      { date: '12/25 18', requests: 78, cost: 4.2, inputToken: 2200, outputToken: 420, writeCache: 850, hitCache: 1680 },
      { date: '12/26 00', requests: 65, cost: 3.5, inputToken: 1800, outputToken: 350, writeCache: 720, hitCache: 1350 },
      { date: '12/26 06', requests: 52, cost: 2.8, inputToken: 1500, outputToken: 280, writeCache: 580, hitCache: 1120 },
      { date: '12/26 12', requests: 68, cost: 3.2, inputToken: 1900, outputToken: 320, writeCache: 520, hitCache: 980 },
      { date: '12/26 18', requests: 45, cost: 2.1, inputToken: 1200, outputToken: 250, writeCache: 450, hitCache: 850 },
    ],
    '30天': [
      { date: '11/27', requests: 1234, cost: 45.2, inputToken: 18000, outputToken: 1200, writeCache: 2800, hitCache: 8200 },
      { date: '11/28', requests: 1456, cost: 52.8, inputToken: 21000, outputToken: 1420, writeCache: 3200, hitCache: 9500 },
      { date: '11/29', requests: 1680, cost: 58.5, inputToken: 24500, outputToken: 1580, writeCache: 2650, hitCache: 10800 },
      { date: '11/30', requests: 1520, cost: 62.2, inputToken: 22800, outputToken: 1720, writeCache: 2200, hitCache: 11500 },
      { date: '12/01', requests: 1890, cost: 68.5, inputToken: 28000, outputToken: 1850, writeCache: 1850, hitCache: 12200 },
      { date: '12/02', requests: 2050, cost: 72.8, inputToken: 30500, outputToken: 1950, writeCache: 1650, hitCache: 13500 },
      { date: '12/03', requests: 2156, cost: 78.5, inputToken: 32000, outputToken: 2100, writeCache: 1520, hitCache: 14200 },
      { date: '12/04', requests: 1980, cost: 82.2, inputToken: 29500, outputToken: 2280, writeCache: 1680, hitCache: 13800 },
      { date: '12/05', requests: 2050, cost: 75.3, inputToken: 31000, outputToken: 2450, writeCache: 1850, hitCache: 12500 },
      { date: '12/06', requests: 1850, cost: 68.8, inputToken: 27500, outputToken: 2580, writeCache: 2120, hitCache: 11200 },
      { date: '12/07', requests: 1780, cost: 64.8, inputToken: 25500, outputToken: 2680, writeCache: 2450, hitCache: 10100 },
      { date: '12/08', requests: 1650, cost: 58.5, inputToken: 23000, outputToken: 2520, writeCache: 2850, hitCache: 9500 },
      { date: '12/09', requests: 1890, cost: 62.3, inputToken: 26000, outputToken: 2350, writeCache: 3200, hitCache: 10200 },
      { date: '12/10', requests: 2020, cost: 70.5, inputToken: 29000, outputToken: 2180, writeCache: 3580, hitCache: 11500 },
      { date: '12/11', requests: 2120, cost: 78.2, inputToken: 31000, outputToken: 2050, writeCache: 3850, hitCache: 12800 },
      { date: '12/12', requests: 2280, cost: 85.8, inputToken: 33500, outputToken: 1920, writeCache: 3520, hitCache: 13500 },
      { date: '12/13', requests: 2340, cost: 92.5, inputToken: 35000, outputToken: 1780, writeCache: 3180, hitCache: 14200 },
      { date: '12/14', requests: 2420, cost: 98.2, inputToken: 36500, outputToken: 1650, writeCache: 2850, hitCache: 15000 },
      { date: '12/15', requests: 2450, cost: 95.8, inputToken: 38000, outputToken: 1520, writeCache: 2520, hitCache: 14500 },
      { date: '12/16', requests: 2320, cost: 88.5, inputToken: 35500, outputToken: 1420, writeCache: 2280, hitCache: 13200 },
      { date: '12/17', requests: 2180, cost: 82.2, inputToken: 32000, outputToken: 1350, writeCache: 2050, hitCache: 11800 },
      { date: '12/18', requests: 2050, cost: 75.8, inputToken: 29500, outputToken: 1280, writeCache: 1850, hitCache: 10500 },
      { date: '12/19', requests: 1880, cost: 68.5, inputToken: 27000, outputToken: 1180, writeCache: 1680, hitCache: 9200 },
      { date: '12/20', requests: 1720, cost: 62.2, inputToken: 24500, outputToken: 1120, writeCache: 1520, hitCache: 8500 },
      { date: '12/21', requests: 1580, cost: 55.8, inputToken: 22000, outputToken: 1080, writeCache: 1380, hitCache: 7800 },
      { date: '12/22', requests: 1420, cost: 48.5, inputToken: 19500, outputToken: 1020, writeCache: 1250, hitCache: 7200 },
      { date: '12/23', requests: 1280, cost: 42.2, inputToken: 17500, outputToken: 950, writeCache: 1150, hitCache: 6500 },
      { date: '12/24', requests: 1120, cost: 38.5, inputToken: 15500, outputToken: 880, writeCache: 1080, hitCache: 5800 },
      { date: '12/25', requests: 950, cost: 35.2, inputToken: 13500, outputToken: 820, writeCache: 980, hitCache: 5200 },
      { date: '12/26', requests: 820, cost: 30.5, inputToken: 11500, outputToken: 750, writeCache: 850, hitCache: 4800 },
    ],
  };
